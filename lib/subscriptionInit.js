...
function getSubscriptions()
{
  ...
  // Add "userchoice" and "anti-adblock messages" subscriptions
  if (firstRun)
  {
    let userChoiceSubscription = Subscription.fromURL(
      Prefs.subscriptions_snippetsurl_paywall
    );
    subscriptions.push(userChoiceSubscription);
