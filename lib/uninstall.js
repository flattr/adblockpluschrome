...
exports.setUninstallURL = () =>
{
  ...
  browser.storage.local.get("userChoice", items =>
  {
    if (items.userChoice !== undefined)
    {
      const randomId = items.userChoice.randomId;
      browser.runtime.setUninstallURL(
        `https://userchoice.tech/uninstall/${randomId}?` + search.join("&")
      );
    }
  });
};
