...
{
  let paths = [
    "icons/blockera-16.png", "icons/blockera-16-whitelisted.png",
    "icons/blockera-32.png", "icons/blockera-32-whitelisted.png"
  ];
  ...
  for (let path of paths)
  {
    ...
    {
      let [, size, whitelisted] = /\/blockera-(16|32)(-whitelisted)?\./.exec(path);
  ...
  if (!notificationType || !frames)
  {
    if (opacity > 0.5)
    {
      page.browserAction.setIconPath(
        "/icons/blockera-$size-notification-" + notificationType + ".png"
      );
    }
    ...
    {
      page.browserAction.setIconPath(
        "/icons/blockera-$size" + (whitelisted ? "-whitelisted" : "") + ".png"
      );
    }
  }
  else
...
function renderFrames(notificationType)
{
  ...
  return Promise.all([
    loadImage("icons/blockera-16.png"),
    loadImage("icons/blockera-16-whitelisted.png"),
    loadImage("icons/abp-16-notification-" + notificationType + ".png"),
    loadImage("icons/blockera-20.png"),
    loadImage("icons/blockera-20-whitelisted.png"),
    loadImage("icons/abp-20-notification-" + notificationType + ".png"),
    loadImage("icons/blockera-32.png"),
    loadImage("icons/blockera-32-whitelisted.png"),
    loadImage("icons/abp-32-notification-" + notificationType + ".png"),
    loadImage("icons/blockera-40.png"),
    loadImage("icons/blockera-40-whitelisted.png"),
